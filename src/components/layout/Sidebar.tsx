...
const Sidebar = () => {
  ...
  const menuItems = [
    ...
    { path: '/tasks', label: 'المهام', icon: ListTodo, show: true },
    ...
    { path: '/employees', label: 'الموظفين', icon: UserCog, show: isOwner() },
    { path: '/attendance', label: 'الحضور والانصراف', icon: Clock, show: isOwner() },
